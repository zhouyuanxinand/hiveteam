                ...
                <>
                  <div className="dispatch-verification-version">
                    <span>
                      ...
                      <code title={view.headSha ?? ''}>{view.headSha?.slice(0, 12) ?? '—'}</code>
                    </span>
                    <button
                      type="button"
                      className="activity-center-icon-button"
                  ...
                  {!view.headSha || view.unavailableReason ? (
                    <p className="dispatch-report-note">{t('verification.gitRequired')}</p>
                  ) : null}
                  {view.isDirty ? (
                  ...
                  {latest ? (
                    ...
                    >
                      ...
                      <p className="dispatch-report-note">
                        {new Date(latest.startedAt).toLocaleString()} · {t('verification.exitCode')}{' '}
                        {latest.exitCode ?? '—'}
                      </p>
